...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ConnectionsModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ConnectionsModel_t qt_meta_stringdata_ConnectionsModel = {
    {
QT_MOC_LITERAL(0, 0, 16) // "ConnectionsModel"
...
QT_INIT_METAOBJECT const QMetaObject ConnectionsModel::staticMetaObject = { {
    &QAbstractTableModel::staticMetaObject,
    qt_meta_stringdata_ConnectionsModel.data,
    qt_meta_data_ConnectionsModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ConnectionsModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConnectionsModel.stringdata0))
